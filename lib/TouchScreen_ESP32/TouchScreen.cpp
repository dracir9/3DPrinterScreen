...
TSPoint TouchScreen::getPoint(void) {
    ...
    pinMode(_xm, OUTPUT);
        ...
        #ifdef ESP32
            GPIO.out_w1ts = xp_pin;
            GPIO.out_w1tc = xm_pin;
        #else
            *xp_port |= xp_pin;
            *xm_port &= ~xm_pin;
        #endif
...
//############################################################
    ...
    #if defined (USE_FAST_PINIO)
        #ifdef ESP32
            GPIO.out_w1ts = yp_pin;
            GPIO.out_w1tc = ym_pin;
        #else
            *ym_port &= ~ym_pin;
            *yp_port |= yp_pin;
        #endif
...
//############################################################
    ...
    #if defined (USE_FAST_PINIO)
        #ifdef ESP32
            GPIO.out_w1ts = ym_pin;
            GPIO.out_w1tc = xp_pin;
        #else
            *xp_port &= ~xp_pin;
            *ym_port |= ym_pin;
        #endif
...
int TouchScreen::readTouchX(void) {
    ...
    pinMode(_xm, OUTPUT);
        ...
        GPIO.out_w1ts = xp_pin;
        GPIO.out_w1tc = xm_pin | ym_pin | yp_pin;
    #else
...
int TouchScreen::readTouchY(void) {
    ...
    #if defined (USE_FAST_PINIO) && defined (ESP32)
        GPIO.out_w1ts = yp_pin;
        GPIO.out_w1tc = xm_pin | ym_pin | xp_pin;
    #else
        digitalWrite(_xp, LOW);
        digitalWrite(_xm, LOW);
        digitalWrite(_yp, HIGH);
...
uint16_t TouchScreen::pressure(void) {
    ...
    #if defined (USE_FAST_PINIO) && defined (ESP32)
        GPIO.out_w1ts = ym_pin;
        GPIO.out_w1tc = xp_pin | xm_pin | yp_pin;
    #else
        digitalWrite(_xp, LOW);
        digitalWrite(_ym, HIGH); 
        digitalWrite(_xm, LOW);
